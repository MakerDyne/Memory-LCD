...
public:     
  MonoLinebuffer();
  bool writePixelToBuffer(uint16_t pixelPosition, bool isWhite);
...
//   uint16_t lcdPixelWidth = 96
//   uint8_t bufferSize = 12;
//   uint8_t buffer[12]   = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
//
  static const uint16_t lcdPixelWidth = 128;
  static const uint8_t bufferSize = 16;
  uint8_t buffer[bufferSize]   = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
//
//   uint16_t lcdPixelWidth = 400;
...
public:     
  ...
  ColourLinebuffer();
  bool writePixelToBuffer(uint16_t pixelPosition, colour c);
  bool writePixelToBuffer(uint16_t pixelPosition, bool isRed, bool isGreen, bool isBlue);
  void clearBuffer();
